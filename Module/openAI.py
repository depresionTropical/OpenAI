...
def make_analysis(data:dict, report:Literal['reporte','retroalimentación'],referencia:Literal['constructo','indicador']) -> str:

    tipo_de_reporte = ['una retroalimentación hacia el tutor', 'un      reporte']
    nivel_de_analisis = ['tutor', 'coordinador programa educativo',
                         'coordinador institución educativa', 'coordinador region', 'coordinador pais']

    detalles_especificos = [
        '', 'los datos son la media, desviación estandar, moda']
